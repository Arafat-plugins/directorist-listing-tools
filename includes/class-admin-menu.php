...
class Directorist_Listing_Tools_Admin_Menu {
	...
	public function add_admin_menu() {
		...
		add_submenu_page(
			$parent_slug,
			esc_html__( 'Pending', 'directorist-listing-tools' ),
			esc_html__( 'Pending', 'directorist-listing-tools' ),
			'manage_options',
		...
		add_submenu_page(
			$parent_slug,
			esc_html__( 'Types', 'directorist-listing-tools' ),
			esc_html__( 'Types', 'directorist-listing-tools' ),
			'manage_options',
		...
		add_submenu_page(
			$parent_slug,
			esc_html__( 'Locations', 'directorist-listing-tools' ),
			esc_html__( 'Locations', 'directorist-listing-tools' ),
			'manage_options',
		...
		add_submenu_page(
			$parent_slug,
			esc_html__( 'Builder Presets', 'directorist-listing-tools' ),
			esc_html__( 'Builder Presets', 'directorist-listing-tools' ),
			'manage_options',
			'directorist-listing-tools-builder-presets',
	...
	/**
	 * Render builder preset reload page.
	 */
	public function render_builder_presets_page() {
		if ( ! dlt_current_user_can() ) {
			wp_die( esc_html__( 'You do not have sufficient permissions to access this page.', 'directorist-listing-tools' ) );
		}
