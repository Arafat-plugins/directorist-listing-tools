	...
	private function define_lwm_settings() {
		$this->lwm_settings = array(
			'bdmv_listings_with_map_columns' => array(
				...
				'description' => __( 'Number of columns in map view.', 'directorist-listing-tools' ),
				'type'        => 'select',
				'default'     => '3',
				'options'     => array(
			...
			'listing_map_view'               => array(
				...
				'description' => __( 'Default view for map shortcode.', 'directorist-listing-tools' ),
				'type'        => 'select',
				'default'     => 'grid',
				'options'     => array(
			...
			'listings_map_viewas'            => array(
				'label'       => __( 'Display "View As"', 'directorist-listing-tools' ),
				'description' => __( 'Show Grid / List switcher.', 'directorist-listing-tools' ),
				'type'        => 'toggle',
				'default'     => 1,
			),
			'listings_map_sortby'            => array(
				'label'       => __( 'Display "Sort By"', 'directorist-listing-tools' ),
				'description' => __( 'Show sort dropdown.', 'directorist-listing-tools' ),
				'type'        => 'toggle',
				'default'     => 1,
			),
		);
	...
	private function get_directory_type_display_settings( $term_id ) {
		...
		return array(
			array(
				...
				'description' => __( 'Show thumbnail on grid cards.', 'directorist-listing-tools' ),
			...
			array(
				...
				'description' => __( 'Show thumbnail on list cards.', 'directorist-listing-tools' ),
	...
	private function define_sections() {
		$this->sections = array(
			'all_listings_header' => array(
				'label'       => __( 'Header & Navigation', 'directorist-listing-tools' ),
				'description' => __( 'Header bar, filters, sorting, and view switcher.', 'directorist-listing-tools' ),
				'icon'        => 'dashicons-menu-alt',
			),
			'card_display'        => array(
				'label'       => __( 'Card Display', 'directorist-listing-tools' ),
				'description' => __( 'Information shown on each listing card.', 'directorist-listing-tools' ),
				'icon'        => 'dashicons-grid-view',
			),
			'single_listing'      => array(
				'label'       => __( 'Single Listing', 'directorist-listing-tools' ),
				'description' => __( 'Per-directory type template settings.', 'directorist-listing-tools' ),
				'icon'        => 'dashicons-admin-post',
			),
			'map_popup'           => array(
				'label'       => __( 'Map Popup', 'directorist-listing-tools' ),
				'description' => __( 'Map marker popup content.', 'directorist-listing-tools' ),
	...
	private function define_settings() {
		$this->settings = array(
			...
			'disable_single_listing'     => array(
				...
				'description' => __( 'Disable single listing detail page.', 'directorist-listing-tools' ),
				'default'     => 0,
			...
			'disable_contact_info'       => array(
				...
				'description' => __( 'Hide contact info on single page.', 'directorist-listing-tools' ),
				'default'     => 0,
				'section'     => 'single_listing',
				'inverse'     => true,
			),
